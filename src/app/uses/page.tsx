			...
			<section>
				...
				<ul className="space-y-4">
					...
					<li>
						...
						<p>
							I know a lot of folks have a really expensive mesh chair that does a lot of things, but I don't. Mine is a cheap
							one from Amazon and it is perfectly comfortable. I did add some rollerblade casters to it, game changer.
						</p>
					</li>
				</ul>
			</section>
			...
			<section>
				...
				<ul className="space-y-4">
					...
					<li>
						...
						<p>
							When my old Apple keyboard went out, I decided to take the plunge and get a clickity clacker. Using it increases
							my development by at least 4x.
						</p>
					</li>
					<li>
						<p>
			...
			<section>
				...
				<ul className="space-y-4">
					<li>
						<p>
							<a
								href="https://audiopen.ai/?aff=Z5K9v"
								target="_blank"
								rel="noreferrer"
			...
			<section>
				...
				<ul className="space-y-4">
					...
					<li>
						...
						<p>
							I was using Warp, and really liking it, but it didn't handle Tmux sessions well. Kitty is GPU driven, so it's
							fast, but pretty no-frills, which is great.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						...
						<p>
							Ray is another debugging tool. It gives you the ability to output exceptions, dumps, and more. I usually leave it
							on the laptop monitor, off to the side, as it listens passively for anything it needs to tell me.
						</p>
					</li>
				</ul>
			</section>
			...
			<section>
				...
				<ul className="space-y-4">
					<li>
						...
						<p>
							I have been using Obsidian lately for my prose and I really like how easy it is to use across my MBP and iPad. I'm
							still tinkering with the plugins and setup, but overall it's a winner.
						</p>
					</li>
					<li>
						<p>
