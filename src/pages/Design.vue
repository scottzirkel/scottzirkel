<template>
  <Layout>
    <article class="w-2/3 self-start py-8">
      <h1 class="uppercase font-title font-black text-center text-4xl">Design</h1>
      ...
      <div class="flex mt-8">
        <a class="block w-1/3 hover:shadow" href="https://dribbble.com/shots/6626854-The-mostly-True-Adventures-of-the-Walsh-Twins">
      ...
      <h2 class="font-tagline font-bold text-2xl uppercase mt-8 mb-2 leading-loose"><a class="text-grey-darkest no-underline hover:underline" href="https://designproacademy.org/">Code of Professional Conduct</a></h2>
