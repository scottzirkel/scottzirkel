...
<html>
  ...
  <body class="font-sans border-t-8 border-b-8 border-red flex items-stretch flex-col min-h-screen bg-grey-lightest text-grey-darkest antialiased">
    ...
    <footer class="text-center text-sm pb-4 font-sans leading-loose container">
      <p>To contact me, please send me a <a class="text-red hover:text-red-dark no-underline hover:underline" href="https://twitter.com/home?status=@scottzirkel%20Hey!">Tweet</a>, a message through <a class="text-red hover:text-red-darker no-underline hover:underline" href="https://t.me/scottzirkel" taget="_blank">Telegram</a>, or contact me through any of the social networks listed at the top of the page.</p>
