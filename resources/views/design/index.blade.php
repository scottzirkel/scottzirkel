...
@section('content')
  <article class="leading-normal">
    ...
    <h2 class="font-tagline font-bold uppercase mt-8 mb-2 leading-loose"><a class="text-grey-darkest no-underline hover:underline" href="https://designproacademy.org/">Code of Professional Conduct</a></h2>
