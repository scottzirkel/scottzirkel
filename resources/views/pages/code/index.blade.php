<x-app-layout title="Code by">
    <x-slot:title>Code by</x-slot:title>
    <x-slot:description>I'm a full time web developer specializing mostly in Laravel with the TALL stack. I also have a small collection of articles on web development. If you're here looking for a discount code, I have terrible news.</x-slot:description>
    <div class="monitor relative mx-auto aspect-[4/3] w-full rounded-xl border-8 border-black bg-gradient-conic from-stone-600 to-stone-900 p-4 shadow-2xl blur-[0.25px]">
        ...
        <div class="pointer-events-none absolute inset-x-0 bottom-0 h-1/6 w-full bg-gradient-to-t from-black"></div>
        <div class="pointer-events-none absolute inset-x-0 top-0 h-1/6 w-full bg-gradient-to-b from-black"></div>
        <div class="scanlines pointer-events-none absolute inset-0 z-[100] size-full mix-blend-overlay blur-[0.25px]"></div>
        <div class="relative size-full space-y-6 overflow-x-hidden overflow-y-scroll overscroll-contain rounded-3xl border-2 border-black bg-gradient-ellipse from-green-800 to-black p-4 pb-[50%] font-mono text-base text-green-300 mix-blend-multiply shadow-inner blur-[0.5px] selection:bg-green-300 selection:text-green-900 screenScrollbars">
