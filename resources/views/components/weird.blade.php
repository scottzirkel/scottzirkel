<section
    class="space-y-8 px-4 py-12 text-center font-weird text-tone-100 antialiased sm:space-y-2"
    title="WebRings! Admit it, you miss them too..."
>
    <h3 class="text-xl">WEIRD WIDE WEB!</h3>
    ...
    <div class="flex flex-col items-center justify-center gap-4 text-xs sm:flex-row">
