...
<article class="leading-normal">
  ...
  <ul class="list-reset">
    <li><a class="text-red hover:text-red-darker no-underline hover:underline" href="https://medium.com/alara-creative/a-year-with-tailwind-92f420b2f8b9">A Year with Tailwind</a> - My continuing adventures with <a class="text-red hover:text-red-darker no-underline hover:underline" href="https://tailwindcss.com" target="_blank">TailwindCSS</a>, a utility-first CSS framework. Spoiler: I love it.</li>
